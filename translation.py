...
ᴊᴜsᴛ sᴇɴᴅ ᴍᴇ ʏᴛ ʟɪɴᴋ,ɢᴅʀɪᴠᴇ ʟɪɴᴋ ᴏʀ ᴅɪʀᴇᴄᴛ ʟɪɴᴋ ᴀɴᴅ ɪ ᴡɪʟʟ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ғᴏʀ ʏᴏᴜ ᴡɪᴛʜ ʏᴏᴜʀ ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ

Mᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: <a href="https://t.me/EK4MPREETSINGH">◈Eᴋᴀᴍᴘʀᴇᴇᴛ Sɪɴɢʜ◈</a></b>
"""

    TECH_VJ_HELP_TEXT = """
<b>◉ʜᴇʀᴇ ᴀʀᴇ ᴛʜᴇ ғᴇᴀᴛᴜʀᴇs◉
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            ...
            InlineKeyboardButton('🍀 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Galaxy_Bots1')
        ], [
